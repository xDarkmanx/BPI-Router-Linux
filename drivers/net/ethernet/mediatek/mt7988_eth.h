...
#define MTK_QDMA_RING_SIZE 4096
...
#define MTK_HW_FEATURES                                                \
	(NETIF_F_IP_CSUM | NETIF_F_RXCSUM | NETIF_F_HW_VLAN_CTAG_TX |  \
...
#define MTK_PP_PAD \
	(MTK_PP_HEADROOM + SKB_DATA_ALIGN(sizeof(struct skb_shared_info)))
...
#define MTK_ADMA_IRQ_NUM (4)

/* ADMA HW LRO Alter Flow Timer Register */
#define MTK_ADMA_LRO_ALT_REFRESH_TIMER 0x1c
...
#define MTK_GDMA_FWD_CFG(x)                                           \
	({                                                            \
		typeof(x) _x = (x);                                   \
		(_x == MTK_GMAC3_ID) ? 0x540 : 0x500 + (_x * 0x1000); \
	})
...
#define MTK_GDMA_EG_CTRL(x)                                           \
	({                                                            \
		typeof(x) _x = (x);                                   \
		(_x == MTK_GMAC3_ID) ? 0x544 : 0x504 + (_x * 0x1000); \
	})
...
#define MTK_GDMA_MAC_ADRL(x)                                          \
	({                                                            \
		typeof(x) _x = (x);                                   \
		(_x == MTK_GMAC3_ID) ? 0x548 : 0x508 + (_x * 0x1000); \
	})
...
#define MTK_GDMA_MAC_ADRH(x)                                          \
	({                                                            \
		typeof(x) _x = (x);                                   \
		(_x == MTK_GMAC3_ID) ? 0x54C : 0x50C + (_x * 0x1000); \
	})
...
/* ADMA RX Base Pointer Register */
#define MTK_PRX_BASE_PTR0 (reg_map->adma.rss_glo_cfg + 0x100)
#define MTK_PRX_BASE_PTR_CFG(x) (MTK_PRX_BASE_PTR0 + (x * 0x10))

/* ADMA RX CPU Pointer Register */
#define MTK_PRX_CRX_IDX0 (MTK_PRX_BASE_PTR0 + 0x08)
#define MTK_PRX_CRX_IDX_CFG(x) (MTK_PRX_CRX_IDX0 + (x * 0x10))

/* ADMA RX DMA Pointer Register */
...
#define MTK_ADMA_LRO_CTRL_DW1 (reg_map->adma.lro_ctrl_dw0 + 0x04)
#define MTK_ADMA_LRO_CTRL_DW2 (reg_map->adma.lro_ctrl_dw0 + 0x08)
#define MTK_ADMA_LRO_CTRL_DW3 (reg_map->adma.lro_ctrl_dw0 + 0x0c)
#define MTK_ADMA_MODE BIT(15)
#define MTK_LRO_MIN_RXD_SDL (MTK_HW_LRO_SDL_REMAIN_ROOM << 16)

/* ADMA RSS Control Registers */
...
#define MTK_RSS_HASH_KEY_DW(x) (reg_map->adma.rss_glo_cfg + 0x20 + ((x) * 0x4))
#define MTK_RSS_INDR_TABLE_DW(x) \
	(reg_map->adma.rss_glo_cfg + 0x50 + ((x) * 0x4))

#define MTK_CSR_CLKGATE_BYP BIT(30)
#define MTK_MULTI_EN BIT(10)
#define MTK_RX_DMA_LRO_EN BIT(8)
#define MTK_ADMA_SIZE_8DWORDS (1 << 4)

#define MTK_DEC_WCOMP BIT(28)
#define MTK_ADMA_RESV_BUF (0x40 << 16)
#define MTK_ADMA_MULTI_CNT (0xf << 12)
#define MTK_MULTI_EN_V2 BIT(11)
#define MTK_CHK_DDONE BIT(10)

/* ADMA RX DMA Configuration Register */
#define MTK_ADMA_LRO_SDL 0x3000
#define MTK_RX_CFG_SDL_OFFSET 16

/* ADMA Reset Index Register */
#define MTK_PST_DRX_IDX0 BIT(16)
#define MTK_PST_DRX_IDX_CFG(x) (MTK_PST_DRX_IDX0 << (x))

/* ADMA Delay Interrupt Register */
#define MTK_ADMA_DELAY_RX_MASK GENMASK(15, 0)
#define MTK_ADMA_DELAY_RX_EN BIT(15)
#define MTK_ADMA_DELAY_RX_PINT_SHIFT 8
#define MTK_ADMA_DELAY_RX_PTIME_SHIFT 0

#define MTK_ADMA_DELAY_TX_MASK GENMASK(31, 16)
#define MTK_ADMA_DELAY_TX_EN BIT(31)
#define MTK_ADMA_DELAY_TX_PINT_SHIFT 24
#define MTK_ADMA_DELAY_TX_PTIME_SHIFT 16

#define MTK_ADMA_DELAY_PINT_MASK 0x7f
#define MTK_ADMA_DELAY_PTIME_MASK 0xff

#define MTK_MAX_DELAY_INT 0x8f0f
#define MTK_MAX_DELAY_INT_V2 0x8f0f8f0f

/* ADMA HW LRO IP Setting Registers */
#define MTK_LRO_DIP_DW0_CFG(x) (reg_map->adma.lro_rx_ring0_dip_dw0 + (x * 0x40))
#define MTK_RING_MYIP_VLD BIT(9)

/* ADMA HW LRO Ring Control Registers */
#define MTK_LRO_CTRL_DW1_CFG(x) \
	(reg_map->adma.lro_rx_ring0_ctrl_dw1 + (x * 0x40))
#define MTK_LRO_CTRL_DW2_CFG(x) \
	(reg_map->adma.lro_rx_ring0_ctrl_dw2 + (x * 0x40))
#define MTK_LRO_CTRL_DW3_CFG(x) \
	(reg_map->adma.lro_rx_ring0_ctrl_dw3 + (x * 0x40))
...
#define TX_DMA_PLEN0(x) \
	(((x) & eth->soc->tx.dma_max_len) << eth->soc->tx.dma_len_offset)
...
#define RX_DMA_PREP_PLEN0(x) \
	(((x) & eth->soc->rx.dma_max_len) << eth->soc->rx.dma_len_offset)
#define RX_DMA_GET_PLEN0(x) \
	(((x) >> eth->soc->rx.dma_len_offset) & eth->soc->rx.dma_max_len)
...
#define ETHSYS_DMA_AG_MAP_ADMA BIT(0)
...
enum mtk_tx_flags {
	/* ADMA descriptor can point at 1-2 segments. This enum allows us to
...
#define MT7622_CLKS_BITMAP                                                    \
	(BIT_ULL(MTK_CLK_ETHIF) | BIT_ULL(MTK_CLK_ESW) |                      \
	 BIT_ULL(MTK_CLK_GP0) | BIT_ULL(MTK_CLK_GP1) | BIT_ULL(MTK_CLK_GP2) | \
	 BIT_ULL(MTK_CLK_SGMII_TX_250M) | BIT_ULL(MTK_CLK_SGMII_RX_250M) |    \
	 BIT_ULL(MTK_CLK_SGMII_CDR_REF) | BIT_ULL(MTK_CLK_SGMII_CDR_FB) |     \
	 BIT_ULL(MTK_CLK_SGMII_CK) | BIT_ULL(MTK_CLK_ETH2PLL))
#define MT7621_CLKS_BITMAP (0)
#define MT7629_CLKS_BITMAP                                                    \
	(BIT_ULL(MTK_CLK_ETHIF) | BIT_ULL(MTK_CLK_ESW) |                      \
	 BIT_ULL(MTK_CLK_GP0) | BIT_ULL(MTK_CLK_GP1) | BIT_ULL(MTK_CLK_GP2) | \
	 BIT_ULL(MTK_CLK_FE) | BIT_ULL(MTK_CLK_SGMII_TX_250M) |               \
	 BIT_ULL(MTK_CLK_SGMII_RX_250M) | BIT_ULL(MTK_CLK_SGMII_CDR_REF) |    \
	 BIT_ULL(MTK_CLK_SGMII_CDR_FB) | BIT_ULL(MTK_CLK_SGMII2_TX_250M) |    \
	 BIT_ULL(MTK_CLK_SGMII2_RX_250M) | BIT_ULL(MTK_CLK_SGMII2_CDR_REF) |  \
	 BIT_ULL(MTK_CLK_SGMII2_CDR_FB) | BIT_ULL(MTK_CLK_SGMII_CK) |         \
	 BIT_ULL(MTK_CLK_ETH2PLL) | BIT_ULL(MTK_CLK_SGMIITOP))
#define MT7981_CLKS_BITMAP                                                   \
	(BIT_ULL(MTK_CLK_FE) | BIT_ULL(MTK_CLK_GP2) | BIT_ULL(MTK_CLK_GP1) | \
	 BIT_ULL(MTK_CLK_WOCPU0) | BIT_ULL(MTK_CLK_SGMII_TX_250M) |          \
	 BIT_ULL(MTK_CLK_SGMII_RX_250M) | BIT_ULL(MTK_CLK_SGMII_CDR_REF) |   \
	 BIT_ULL(MTK_CLK_SGMII_CDR_FB) | BIT_ULL(MTK_CLK_SGMII2_TX_250M) |   \
	 BIT_ULL(MTK_CLK_SGMII2_RX_250M) | BIT_ULL(MTK_CLK_SGMII2_CDR_REF) | \
	 BIT_ULL(MTK_CLK_SGMII2_CDR_FB) | BIT_ULL(MTK_CLK_SGMII_CK))
#define MT7986_CLKS_BITMAP                                                   \
	(BIT_ULL(MTK_CLK_FE) | BIT_ULL(MTK_CLK_GP2) | BIT_ULL(MTK_CLK_GP1) | \
	 ...
	 BIT_ULL(MTK_CLK_SGMII_TX_250M) | BIT_ULL(MTK_CLK_SGMII_RX_250M) |   \
	 BIT_ULL(MTK_CLK_SGMII_CDR_REF) | BIT_ULL(MTK_CLK_SGMII_CDR_FB) |    \
	 BIT_ULL(MTK_CLK_SGMII2_TX_250M) | BIT_ULL(MTK_CLK_SGMII2_RX_250M) | \
	 BIT_ULL(MTK_CLK_SGMII2_CDR_REF) | BIT_ULL(MTK_CLK_SGMII2_CDR_FB))
#define MT7988_CLKS_BITMAP                                                     \
	(BIT_ULL(MTK_CLK_FE) | BIT_ULL(MTK_CLK_ESW) | BIT_ULL(MTK_CLK_GP1) |   \
	 BIT_ULL(MTK_CLK_GP2) | BIT_ULL(MTK_CLK_GP3) | BIT_ULL(MTK_CLK_XGP1) | \
	 BIT_ULL(MTK_CLK_XGP2) | BIT_ULL(MTK_CLK_XGP3) |                       \
	 BIT_ULL(MTK_CLK_CRYPTO) | BIT_ULL(MTK_CLK_ETHWARP_WOCPU2) |           \
	 BIT_ULL(MTK_CLK_ETHWARP_WOCPU1) | BIT_ULL(MTK_CLK_ETHWARP_WOCPU0) |   \
	 BIT_ULL(MTK_CLK_TOP_ETH_GMII_SEL) |                                   \
	 BIT_ULL(MTK_CLK_TOP_ETH_REFCK_50M_SEL) |                              \
	 BIT_ULL(MTK_CLK_TOP_ETH_SYS_200M_SEL) |                               \
	 BIT_ULL(MTK_CLK_TOP_ETH_SYS_SEL) |                                    \
	 BIT_ULL(MTK_CLK_TOP_ETH_XGMII_SEL) |                                  \
	 BIT_ULL(MTK_CLK_TOP_ETH_MII_SEL) | BIT_ULL(MTK_CLK_TOP_NETSYS_SEL) |  \
...
enum mtk_dev_state { MTK_HW_INIT, MTK_RESETTING };
...
#define MTK_ETH_MUX_GDM1_TO_GMAC1_ESW BIT_ULL(MTK_ETH_MUX_GDM1_TO_GMAC1_ESW_BIT)
#define MTK_ETH_MUX_GMAC2_GMAC0_TO_GEPHY \
	BIT_ULL(MTK_ETH_MUX_GMAC2_GMAC0_TO_GEPHY_BIT)
#define MTK_ETH_MUX_U3_GMAC2_TO_QPHY BIT_ULL(MTK_ETH_MUX_U3_GMAC2_TO_QPHY_BIT)
#define MTK_ETH_MUX_GMAC2_TO_2P5GPHY BIT_ULL(MTK_ETH_MUX_GMAC2_TO_2P5GPHY_BIT)
...
#define MTK_MUX_GMAC1_GMAC2_TO_SGMII_RGMII \
	(MTK_ETH_MUX_GMAC1_GMAC2_TO_SGMII_RGMII | MTK_MUX | MTK_SHARED_SGMII)
...
#define MT7988_CAPS                                                           \
	(MTK_36BIT_DMA | MTK_GDM1_ESW | MTK_GMAC1_SGMII | MTK_GMAC2_2P5GPHY | \
	 MTK_GMAC2_SGMII | MTK_GMAC2_USXGMII | MTK_GMAC3_SGMII |              \
	 MTK_GMAC3_USXGMII | MTK_MUX_GMAC123_TO_GEPHY_SGMII |                 \
	 MTK_MUX_GMAC123_TO_USXGMII | MTK_MUX_GMAC2_TO_2P5GPHY | MTK_QDMA |   \
	 MTK_RSTCTRL_PPE1 | MTK_RSTCTRL_PPE2 | MTK_SRAM | MTK_RSS)
...
struct mtk_reg_map {
	...
	struct {
		...
		u32 lro_ctrl_dw0;
		u32 rx_cfg;
		u32 lro_alt_score_delta; /* ADMA HW LRO Alter Flow Delta Register */
		u32 rss_delay_int;
		u32 lro_tx1_dly_int;
		u32 lro_tx2_dly_int;
		u32 lro_tx3_dly_int;
